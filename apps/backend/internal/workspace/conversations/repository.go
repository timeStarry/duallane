...
type ReadRepository interface {
	...
	ListMessageAttachments(ctx context.Context, spaceID, viewerID string, messageIDs []string) (map[string][]workspaceMessages.AttachmentRecord, error)
	ListMessageReactions(ctx context.Context, spaceID, viewerID string, messageIDs []string) (map[string][]workspaceMessages.ReactionGroup, error)
	ListMessageHidden(ctx context.Context, spaceID, viewerID string, messageIDs []string) (map[string]bool, error)
