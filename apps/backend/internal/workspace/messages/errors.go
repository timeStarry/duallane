...
const (
	...
	CodeMessageInvalidEmoteShare = "message.invalid_emote_collection"
	CodeMessageInvalidTopic      = "message.invalid_topic"
...
const (
	...
	MessageInvalidEmoteShare    = "表情合集分享不可用"
	MessageInvalidTopic         = "话题不可用或你尚未加入该话题"
