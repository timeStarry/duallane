...
const (
	...
	CodeEmoteSourceTooLarge                 = "emote.source_too_large"
	CodeEmoteNotFound                       = "emote.not_found"
	CodeEmoteStorageMissing                 = "emote.storage_missing"
	CodeEmoteStorageMismatch                = "emote.storage_mismatch"
	CodeFileInvalidStorageKey               = "file.invalid_storage_key"
	...
	CodeEmoteSubscriptionRequiresCollection = "emote.subscription_requires_collection"
	CodeEmoteSubscriptionSourceUnavailable  = "emote.subscription_source_unavailable"
	CodeEmoteSubscriptionConflict           = "emote.subscription_conflict"
...
const (
	...
	MessageEmoteSourceTooLarge                 = "图片过大，无法收藏为表情"
	MessageEmoteNotFound                       = "收藏表情不存在"
	MessageEmoteStorageMissing                 = "收藏表情内容不可用"
	MessageEmoteStorageMismatch                = "收藏表情内容不可用"
	MessageFileInvalidStorageKey               = "文件存储路径无效"
	...
	MessageEmoteSubscriptionRequiresCollection = "只能订阅完整合集"
	MessageEmoteSubscriptionSourceUnavailable  = "原作者合集已不可用"
	MessageEmoteSubscriptionConflict           = "订阅状态已变化，请重试"
