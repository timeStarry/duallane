...
import { loadWorkspaceS3Config } from "./object-store.mjs";
...
async function verifyWorkspaceMultipartCleanupAccess({ client, bucket }) {
  const key = `workspace/migration-archive/provisioning/multipart-cleanup-canary-${randomUUID()}`;
