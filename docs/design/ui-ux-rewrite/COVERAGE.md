...
| 长按后持续按住再释放不误关闭，后续独立点击与原生滚动正常 | [对象操作](CONTEXT_AND_SETTINGS.md) | [长按指针生命周期验证](../../../apps/web/src/ui/primitives/verify-longpress-release.mjs)、[中栏持按回归](../../../e2e/workspace-middle-pane.spec.ts) |
| 历史布局变化后菜单保持在视口内、主动滚动关闭、对象移除失效 | [对象操作](CONTEXT_AND_SETTINGS.md) | [浮层几何回归](../../../apps/web/src/ui/primitives/popup.test.ts)、[真实菜单与焦点验证](../../../apps/web/src/ui/primitives/verify-menu-viewport.mjs) |
